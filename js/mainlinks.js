$(document).ready(function() {
  ...
  lineWidth("#mainlink1", "#line-1", "280px", "30px");
  lineWidth("#mainlink2", "#line-2", "176px", "30px");
  lineWidth("#mainlink3", "#line-3", "320px", "60px");
  lineWidth("#mainlink4", "#line-4", "106px", "10px");
  lineWidth("#mainlink5", "#line-5", "108px", "10px");
